...
/* This file is different from main.js because it is meant for top level pages, so all of the paths for the links are in the format    FOLDER/FILENAME.HTML
In the main.js file, all the paths are in the format    ../FOLDER/FILENAME.HTML   because we are linking back up to the site root 
*/
